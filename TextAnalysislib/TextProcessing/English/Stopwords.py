...
def load_stopword(file_name):
    stopword_list = open(file_name).read().strip().split("\n")
    return stopword_list

def get_stopword_list(type_name):   
    if type_name == "nltk":
        return getNltkStopword()
    elif type_name == "sklearn":
        return getSklearnStopword()
    elif type_name == "spacy":
        return getSpacyStopword()
    elif type_name == "yoast":
        return getYoastStopword()
    elif type_name == "humbolt":
        return getHumboltStopword()
